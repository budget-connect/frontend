  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center w-full py-2 mx-auto">
        <main className="flex flex-col items-center justify-center flex-1 w-full px-4 text-center sm:flex-row sm:mt-2 sm:gap-8">
          <div className="sm:w-1/2">
            <h1 className="sm:text-xl text-md max-w-[708px] font-bold text-slate-900">
