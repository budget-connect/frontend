    ...
    <section className="container mx-auto py-6 sm:py-16 lg:py-20">
      <div className="bg-base-300 w-full py-16 md:py-32">
        ...
        <p className="text-center text-lg tracking-wide">
          ...
          confidence in their investment decisions. The platform has established
          partnerships with renowned financial institutions and secured a
      ...
      <div className="mx-auto pt-10 lg:pt-32">
        <div className="flex flex-col items-center lg:flex-row">
                ...
                <div>
                  <blockquote>
                    <p className="text-3xl font-bold text-white sm:text-5xl">
                      &ldquo;Our vision is to empower individuals to build a
                      strong financial foundation, regardless of their current
                      savings and investment habits&ldquo;
                    </p>
                  </blockquote>
                </div>
          ...
          <div className="relative mr-auto grid max-w-lg grid-cols-1 gap-y-14 lg:pl-20">
            <div className="flex flex-col">
              <div>
                <blockquote>
                  <p className="text-lg leading-relaxed">
                    &ldquo;We believe that everyone deserves the opportunity to
                    enjoy the benefits of regular investments&ldquo;
                  </p>
                </blockquote>
              </div>
            ...
            <div className="flex flex-col">
              <div>
                <blockquote>
                  <p className="text-lg leading-relaxed">
                    &ldquo;We are committed to providing the tools and resources
                    needed to make this a reality. &ldquo;
                  </p>
                </blockquote>
              </div>
            ...
            <div className="flex flex-col">
              <div>
                <blockquote>
                  <p className="text-lg leading-relaxed">
                    &ldquo;Our ultimate goal is to revolutionize the way people
                    approach savings and investing, leading to a more
                    financially secure future for all.&ldquo;
                  </p>
                </blockquote>
              </div>
